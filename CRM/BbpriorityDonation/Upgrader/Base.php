 ...
 */
class CRM_BbpriorityDonation_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate.
      self::$instance = new CRM_BbpriorityDonation_Upgrader(
        'info.kabbalah.payment.bbpriorityDonation',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_BbpriortyDonation_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
