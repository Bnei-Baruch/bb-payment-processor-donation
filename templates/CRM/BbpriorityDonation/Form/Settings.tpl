<div class="crm-block crm-form-block">
  <table class="form-layout">
    <tr class="crm-bbpriorityDonation-form-block-ipn_http">
      <td width="20%">
        {$form.ipn_http.label}
      </td>
      <td>
        {$form.ipn_http.html}
        <br>
        <span class="description">bbpriorityDonation doesn't support ipn callbacks using SSL shared certificate in multiples websites with a single IP. In that case you must force to use http protocol in ipn callback url</span>
      </td>
    </tr>
    <tr class="crm-bbpriorityDonation-form-block-merchant_terminal">
      <td width="20%">
